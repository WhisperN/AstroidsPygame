...
# + Keys.ENTER
driver.find_element(By.ID, "email").send_keys("YourEMAIL")
driver.find_element(By.ID, "password").send_keys(__pwd__ + Keys.ENTER)

# Find a seat && open page of seat
driver.find_element(By.LINK_TEXT, "Y15/127").send_keys(Keys.ENTER)
...
selectFaculty.select_by_value("YourFACULTY")
